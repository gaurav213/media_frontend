        ...
        <div className="fixed   top-[10px] left-[20px] right-[20px] bottom-[10px] h-[100vh] w-[100vw]  flex items-center justify-center">
          <div className="relative h-[70vh] w-[85vw] md:w-[60vw] lg:w-[40vw] bg-white rounded-lg ">
            <div className="flex items-center justify-center mt-2">
              ...
              <div
                onClick={() => {
                  setOpenPostImg(!openPostImg);
                }}
                className=" absolute top-[-12px] right-[-10px] bg-violet-600 rounded-full cursor-pointer hover:scale-105  "
              >
            ...
            <div className=" flex flex-col gap-5 items-center justify-center h-full w-full rounded-lg">
              ...
              <div className="flex gap-2">
                ...
                <input
                  type="text"
                  className="w-[100%] border-2 border-violet-500 rounded-md"
                />
              </div>
              <button className="bg-violet-600 p-2 rounded-md w-[50%] mt-4 text-white hover:shadow-lg ">
                Upload
              </button>
            </div>
          </div>
